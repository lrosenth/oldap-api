...
def factory():
    ...
    from oldap_api.views import archive_views, archive_structure_views, writer_recovery_views, archive_publication_views
    ...
    app.register_blueprint(archive_publication_views.archive_publication_bp)
    app.register_blueprint(writer_recovery_views.writer_recovery_bp)
